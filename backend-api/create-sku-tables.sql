...
CREATE TABLE IF NOT EXISTS `pr_product_specifications` (
  ...
  CONSTRAINT `fk_spec_product` FOREIGN KEY (`product_id`) REFERENCES `pr_goods`(`id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `pr_product_skus` (
  ...
  CONSTRAINT `fk_sku_product` FOREIGN KEY (`product_id`) REFERENCES `pr_goods`(`id`) ON DELETE CASCADE
